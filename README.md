# 生成 Mybatis 基础的增删改查 SQL

## 说明

外包项目做多了之后，会发现有很多简单的增删改查的代码，没有技术含量，却要花费很多时间去写，浪费青春

于是有了这样一个脚本，根据数据库结构生成对应的 Mybatis 的 SQL、Model、Mapper、Service、Controller 等

细节可根据个人喜好调整，目前是按照我的项目风格生成的
