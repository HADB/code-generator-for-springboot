...
interface RolePermissionMapper {
    ...
    fun updateRolePermission(@Param("rolePermission") rolePermission: RolePermission)
    ...
    fun selectPagingRolePermissionsCount(@Param("request") request: RolePermissionSearchRequest): Long
}