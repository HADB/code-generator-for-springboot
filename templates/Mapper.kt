...
interface ${model_name_pascal_case}Mapper {
    ...
    fun update${model_name_pascal_case}(@Param("${model_name_camel_case}") ${model_name_camel_case}: ${model_name_pascal_case})
    ...
    fun selectPaging${model_name_plural_pascal_case}(@Param("request") request: ${model_name_pascal_case}SearchRequest): List<${model_name_pascal_case}>
    fun selectPaging${model_name_plural_pascal_case}Count(@Param("request") request: ${model_name_pascal_case}SearchRequest): Long
}