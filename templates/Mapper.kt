...
interface ${model_name_pascal_case}Mapper {
    ...
    fun select${model_name_pascal_case}(@Param("request") request: ${model_name_pascal_case}SearchRequest): ${model_name_pascal_case}?
    fun select${model_name_pascal_case_plural}(@Param("request") request: ${model_name_pascal_case}SearchRequest): List<${model_name_pascal_case}>
