...
interface ${model_name_pascal_case}Mapper {
    ...
    fun selectPaging${model_name_pascal_case}s(@Param("request") request: ${model_name_pascal_case}SearchRequest): List<${model_name_pascal_case}>
    fun selectPaging${model_name_pascal_case}sCount(@Param("request") request: ${model_name_pascal_case}SearchRequest): Long
}